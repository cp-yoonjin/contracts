...
contract RootChain is RootChainStorage, IRootChain, Initializable {
  using SafeMath for uint256;
  using RLPReader for bytes;
  using RLPReader for RLPReader.RLPItem;

  function initialize() external initializer {
    require(_buildHeaderBlock(address(0x0000000000000000000000000000000000000000), 0, 10, 0xc7b84431d3467cc918d42d20b111b298b290851c5c37406e8b6ef0e7900e514f), "INCORRECT_HEADER_DATA");
